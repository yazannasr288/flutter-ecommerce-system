...
class Listitemshomebest extends GetView<HomecontrollerImp> {
  const Listitemshomebest({super.key});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.builder(
        itemCount: controller.bestitems.length,
        scrollDirection: Axis.horizontal,
        itemBuilder: (context, i) {
          return Itemshome(
            itemsModel: ItemsModel.fromJson(controller.bestitems[i]),
          );
        },
      ),
    );
