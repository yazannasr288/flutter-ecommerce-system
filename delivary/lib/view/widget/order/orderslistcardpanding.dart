      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            // إذا أردت تفعيل هذا لاحقاً:
            // _buildRow("146".tr, " ${controller.printtyprorder(listdata.ordersType!)}", _valueStyle),
            // const Divider(),
            ...
            _buildRow(
              "رقم هاتف الزبون".tr,
              " ${listdata.userphone}",
              _valueStyle.copyWith(decoration: TextDecoration.underline),
              onTap: () => controller.callNumber(listdata.userphone!),
            ),
            const Divider(),
            _buildRow("148".tr, "${listdata.ordersPricedilivery}\$", _valueStyle),
            const Divider(),
            _buildRow("149".tr, "${controller.printpamentmetodeorder(listdata.ordersPaymethod!)}", _valueStyle),
            const Divider(),
            // إذا أردت تفعيل هذا لاحقاً:
            // _buildRow("150".tr, "${controller.printorderstatus(listdata.ordersStatus!)}", _valueStyle),
            // const Divider(),
            _buildRow("151".tr, "${listdata.ordersTotalprice}\$", _valueStyle.copyWith(fontSize: 20)),
            const Divider(),
            Row(
              children: [
                ElevatedButton(
