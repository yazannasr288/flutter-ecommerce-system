...
$stmt = $con->prepare("SELECT items1view.*, 
IF(favorite.favorite_usersid IS NOT NULL, 1, 0) as favorite, 
(items1view.items_price - (items1view.items_price * items1view.items_discount / 100)) as itemspricediscount
FROM items1view
LEFT JOIN favorite ON favorite.favorite_itemsid = items1view.items_id 
