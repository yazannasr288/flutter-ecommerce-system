...
class OrdersModel {
  ...
  OrdersModel.fromJson(Map<String, dynamic> json) {
    ...
    orderdellivaryid = json['orders_delivary']?.toString();
    userphone = json['user_phone']?.toString();
    delivaryphone = json['delivary_phone']?.toString();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['orders_delivary'] = orderdellivaryid;
    data['user_phone'] = userphone;
    data['delivary_phone'] = delivaryphone;
    return data;
  }
}
