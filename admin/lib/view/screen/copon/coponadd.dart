import 'package:admin/controller/copon/addcontroller.dart';
...
class Coponadd extends StatelessWidget {
  const Coponadd({super.key});

  @override
  Widget build(BuildContext context) {
    CoponAddcontroller controller = Get.put(CoponAddcontroller());
    return Scaffold(
      appBar: AppBar(title: Text("263".tr)),
      body: GetBuilder<CoponAddcontroller>(
